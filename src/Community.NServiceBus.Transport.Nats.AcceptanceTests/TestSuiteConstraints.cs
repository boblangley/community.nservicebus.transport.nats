...
public partial class TestSuiteConstraints
{
    ...
    public bool SupportsPurgeOnStartup => false; // Not implemented yet

    public IConfigureEndpointTestExecution CreateTransportConfiguration() => new ConfigureEndpointNatsTransport();
